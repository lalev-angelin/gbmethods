...
for iteration in range(0, 100):
    ...
    for h in range (11, -1, -1):
        ...
        #file = open(os.path.join(result_dir, "xgboost-model_i%d_%d."%(iteration,h)), "wb")
    ...
    file = open(os.path.join(result_dir, "xgboost-i%d.json"%iteration), "w")
    file.write(strout)
    file.close()
